      ...
      <div className="text-center animate-scaleIn relative z-10">
        ...
        <div className="relative w-24 h-24 mx-auto mb-6">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 bg-gradient-to-br from-neon-cyan to-neon-blue rounded-xl flex items-center justify-center shadow-neon-cyan animate-glow-pulse">
              <Shield className="text-white" size={24} />
            </div>
          </div>
        </div>

        <h2 className="text-xl font-bold text-white mb-2 tracking-tight">EnigmaKeep</h2>
        <p className="text-sm text-gray-500 font-mono tracking-wider animate-pulse">INITIALIZING VAULT...</p>
      </div>
    </div>
  );
}
